...
public class InternAppActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intern_app);

        ButterKnife.bind(InternAppActivity.this);
        tv_title.setText("App");
        ...
        rv_img_download.setLayoutManager(new GridLayoutManager(InternAppActivity.this, 3));
        rv_img_download.setNestedScrollingEnabled(false);
        allDocumentAdapter = new AllDocumentAdapter(imgMainDownloadList, InternAppActivity.this, "appData");
        rv_img_download.setAdapter(allDocumentAdapter);

        rv_img_download_list.setLayoutManager(new LinearLayoutManager(InternAppActivity.this, RecyclerView.VERTICAL, false));
        rv_img_download_list.setNestedScrollingEnabled(false);
        allDocListAdapter = new AllDocListAdapter(imgMainDownloadList, InternAppActivity.this, "appData");
        rv_img_download_list.setAdapter(allDocListAdapter);

        img_grid_list.setOnClickListener(v -> {
            if (rl_fram.getVisibility() == View.VISIBLE) {
                img_grid_list.setImageDrawable(InternAppActivity.this.getResources().getDrawable(R.drawable.list_view));
                rl_List.setVisibility(View.VISIBLE);
                rl_fram.setVisibility(View.GONE);
            } else {
                img_grid_list.setImageDrawable(InternAppActivity.this.getResources().getDrawable(R.drawable.gird_view));
    ...
    public void onBackPressed() {
        Intent intent = new Intent(InternAppActivity.this, MainActivity.class);
...
//                        Log.e("LLLLL_Filename_img: ", imagePath.getAbsolutePath());
