...
public class ChildInternAppActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_child_intern_app);
        ButterKnife.bind(ChildInternAppActivity.this);
        tv_title.setText("App Select");

        folderPath = getIntent().getStringExtra("folderPath");

        rv_intern_download.setLayoutManager(new GridLayoutManager(ChildInternAppActivity.this, 3));
        rv_intern_download.setNestedScrollingEnabled(false);
        allDocumentAdapter = new ChildDocAdapter(getListFolder(), ChildInternAppActivity.this, "app");
        rv_intern_download.setAdapter(allDocumentAdapter);

        rv_intern_download_list.setLayoutManager(new LinearLayoutManager(ChildInternAppActivity.this, RecyclerView.VERTICAL, false));
        rv_intern_download_list.setNestedScrollingEnabled(false);
        childDocListAdapter = new ChildDocListAdapter(getListFolder(), ChildInternAppActivity.this, "app");
        ...
        img_grid_list.setOnClickListener(v -> {
            if (rl_fram.getVisibility() == View.VISIBLE) {
                img_grid_list.setImageDrawable(ChildInternAppActivity.this.getResources().getDrawable(R.drawable.list_view));
                rl_List.setVisibility(View.VISIBLE);
                rl_fram.setVisibility(View.GONE);
            } else {
                img_grid_list.setImageDrawable(ChildInternAppActivity.this.getResources().getDrawable(R.drawable.gird_view));
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ChildInternAppActivity.this, InternAppActivity.class);
