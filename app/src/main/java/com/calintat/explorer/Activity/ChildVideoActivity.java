...
public class ChildVideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ButterKnife.bind(ChildVideoActivity.this);
        tv_title.setText("Video Select");

        folderPath = getIntent().getStringExtra("folderPath");

        rv_intern_download.setLayoutManager(new GridLayoutManager(ChildVideoActivity.this, 3));
        rv_intern_download.setNestedScrollingEnabled(false);
        allDocumentAdapter = new ChildDocAdapter(getListFolder(), ChildVideoActivity.this, "video");
        rv_intern_download.setAdapter(allDocumentAdapter);

        rv_intern_download_list.setLayoutManager(new LinearLayoutManager(ChildVideoActivity.this, RecyclerView.VERTICAL, false));
        rv_intern_download_list.setNestedScrollingEnabled(false);
        childDocListAdapter = new ChildDocListAdapter(getListFolder(), ChildVideoActivity.this, "video");
        ...
        img_grid_list.setOnClickListener(v -> {
            if (rl_fram.getVisibility() == View.VISIBLE) {
                img_grid_list.setImageDrawable(ChildVideoActivity.this.getResources().getDrawable(R.drawable.list_view));
                rl_List.setVisibility(View.VISIBLE);
                rl_fram.setVisibility(View.GONE);
            } else {
                img_grid_list.setImageDrawable(ChildVideoActivity.this.getResources().getDrawable(R.drawable.gird_view));
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ChildVideoActivity.this, InternVidActivity.class);
