...
public class ChildDocActivityActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_child_doc_activity);

        ButterKnife.bind(ChildDocActivityActivity.this);
        tv_title.setText("Document Select");

        folderPath = getIntent().getStringExtra("folderPath");

        rv_doc_download.setLayoutManager(new GridLayoutManager(ChildDocActivityActivity.this, 3));
        rv_doc_download.setNestedScrollingEnabled(false);
        allDocumentAdapter = new ChildDocAdapter(getListFolder(), ChildDocActivityActivity.this, "doc");
        rv_doc_download.setAdapter(allDocumentAdapter);

        rv_doc_download_list.setLayoutManager(new LinearLayoutManager(ChildDocActivityActivity.this, RecyclerView.VERTICAL, false));
        rv_doc_download_list.setNestedScrollingEnabled(false);
        childDocListAdapter = new ChildDocListAdapter(getListFolder(), ChildDocActivityActivity.this, "doc");
        rv_doc_download_list.setAdapter(childDocListAdapter);
        ...
        img_grid_list.setOnClickListener(v -> {
            if (rl_fram.getVisibility() == View.VISIBLE){
                img_grid_list.setImageDrawable(ChildDocActivityActivity.this.getResources().getDrawable(R.drawable.list_view));
                rl_List.setVisibility(View.VISIBLE);
                rl_fram.setVisibility(View.GONE);
            } else {
                img_grid_list.setImageDrawable(ChildDocActivityActivity.this.getResources().getDrawable(R.drawable.gird_view));
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ChildDocActivityActivity.this, DocumentActivity.class);
    ...
    private ArrayList<DocumentModel> getListFolder() {
        documentsList.clear();
        documentsList.addAll(DownloadData.getDocumentsData(folderPath));
