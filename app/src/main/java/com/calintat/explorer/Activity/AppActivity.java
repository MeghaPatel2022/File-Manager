...
public class AppActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ButterKnife.bind(AppActivity.this);
        tv_title.setText("App");

        rv_app_download.setLayoutManager(new GridLayoutManager(AppActivity.this, 3));
        rv_app_download.setNestedScrollingEnabled(false);
        allDocumentAdapter = new AllDocumentAdapter(getListFolder(), AppActivity.this, "app");
        rv_app_download.setAdapter(allDocumentAdapter);

        rv_app_download_list.setLayoutManager(new LinearLayoutManager(AppActivity.this, RecyclerView.VERTICAL, false));
        rv_app_download_list.setNestedScrollingEnabled(false);
        allDocListAdapter = new AllDocListAdapter(getListFolder(), AppActivity.this, "app");
        ...
        img_grid_list.setOnClickListener(v -> {
            if (rl_fram.getVisibility() == View.VISIBLE) {
                img_grid_list.setImageDrawable(AppActivity.this.getResources().getDrawable(R.drawable.list_view));
                rl_List.setVisibility(View.VISIBLE);
                rl_fram.setVisibility(View.GONE);
            } else {
                img_grid_list.setImageDrawable(AppActivity.this.getResources().getDrawable(R.drawable.gird_view));
        ...
        img_filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Collections.reverse(getListFolder());
    ...
    private ArrayList<DocumentModel> getListFolder() {
        documentsList.clear();
        documentsList.addAll(DownloadData.getAppFolder(DownloadData.docDirNamedir, documentsList));
