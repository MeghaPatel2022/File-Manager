...
public class ChildZipInternActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_child_intern_zip);

        ButterKnife.bind(ChildZipInternActivity.this);
        tv_title.setText("Zip Select");

        folderPath = getIntent().getStringExtra("folderPath");

        rv_intern_download.setLayoutManager(new GridLayoutManager(ChildZipInternActivity.this, 3));
        rv_intern_download.setNestedScrollingEnabled(false);
        allDocumentAdapter = new ChildDocAdapter(getListFolder(), ChildZipInternActivity.this, "zip");
        rv_intern_download.setAdapter(allDocumentAdapter);

        rv_intern_download_list.setLayoutManager(new LinearLayoutManager(ChildZipInternActivity.this, RecyclerView.VERTICAL, false));
        rv_intern_download_list.setNestedScrollingEnabled(false);
        childDocListAdapter = new ChildDocListAdapter(getListFolder(), ChildZipInternActivity.this, "zip");
        ...
        img_grid_list.setOnClickListener(v -> {
            if (rl_fram.getVisibility() == View.VISIBLE) {
                img_grid_list.setImageDrawable(ChildZipInternActivity.this.getResources().getDrawable(R.drawable.list_view));
                rl_List.setVisibility(View.VISIBLE);
                rl_fram.setVisibility(View.GONE);
            } else {
                img_grid_list.setImageDrawable(ChildZipInternActivity.this.getResources().getDrawable(R.drawable.gird_view));
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ChildZipInternActivity.this, InternZipActivity.class);
    ...
    private ArrayList<DocumentModel> getListFolder() {
        documentsList.clear();
        documentsList.addAll(DownloadData.getInternZipData(new File(folderPath)));
