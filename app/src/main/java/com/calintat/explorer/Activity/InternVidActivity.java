...
public class InternVidActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intern_vid);

        ButterKnife.bind(InternVidActivity.this);
        ...
        rv_img_download.setLayoutManager(new GridLayoutManager(InternVidActivity.this, 3));
        rv_img_download.setNestedScrollingEnabled(false);
        allDocumentAdapter = new AllDocumentAdapter(imgMainDownloadList, InternVidActivity.this, "videos");
        rv_img_download.setAdapter(allDocumentAdapter);

        rv_img_download_list.setLayoutManager(new LinearLayoutManager(InternVidActivity.this, RecyclerView.VERTICAL, false));
        rv_img_download_list.setNestedScrollingEnabled(false);
        allDocListAdapter = new AllDocListAdapter(imgMainDownloadList, InternVidActivity.this, "videos");
        rv_img_download_list.setAdapter(allDocListAdapter);

        img_grid_list.setOnClickListener(v -> {
            if (rl_fram.getVisibility() == View.VISIBLE) {
                img_grid_list.setImageDrawable(InternVidActivity.this.getResources().getDrawable(R.drawable.list_view));
                rl_List.setVisibility(View.VISIBLE);
                rl_fram.setVisibility(View.GONE);
            } else {
                img_grid_list.setImageDrawable(InternVidActivity.this.getResources().getDrawable(R.drawable.gird_view));
    ...
    public void onBackPressed() {
        Intent intent = new Intent(InternVidActivity.this, MainActivity.class);
