...
public class AudiosFrament extends Fragment implements IReverse {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        audDownloadList = DownloadData.getAllAudData(DownloadData.dirNamedir, audDownloadList);
...
//        DownloadMainFragment.img_filter.setOnClickListener(new View.OnClickListener() {
//            @Override
