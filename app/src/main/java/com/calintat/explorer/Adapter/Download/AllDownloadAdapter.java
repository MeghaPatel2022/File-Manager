...
public class AllDownloadAdapter extends RecyclerView.Adapter<AllDownloadAdapter.MyClassView> {

    private final musicActionListerner actionListerner;
    ArrayList<DataModel> fileList = new ArrayList<>();
    Activity activity;

    public AllDownloadAdapter(ArrayList<DataModel> fileList, Activity activity, musicActionListerner actionListerner) {
    ...
    public MyClassView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = inflater.inflate(R.layout.item_download_all, null, false);
...
//                        .into(holder.list_item_image);
    ...
    public class MyClassView extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        @Override
        public void onClick(View v) {
            AllDownloadAdapter.this.actionListerner.onMusicItemClicked(v, getAdapterPosition());
        }
    }
}
