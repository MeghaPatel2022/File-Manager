...
public class AllDocListAdapter extends RecyclerView.Adapter<AllDocListAdapter.MyClassView> {

    ArrayList<DocumentModel> fileList;
    Activity activity;
    String from = "";

    public AllDocListAdapter(ArrayList<DocumentModel> fileList, Activity activity, String from) {
