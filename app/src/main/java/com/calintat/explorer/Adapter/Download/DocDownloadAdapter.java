...
public class DocDownloadAdapter extends RecyclerView.Adapter<DocDownloadAdapter.MyClassView> {

    ArrayList<DataModel> fileList = new ArrayList<>();
    Activity activity;

    public DocDownloadAdapter(ArrayList<DataModel> fileList, Activity activity) {
    ...
    public MyClassView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = inflater.inflate(R.layout.item_download_doc, null, false);
