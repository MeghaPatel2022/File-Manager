...
public class AllGdriveAdapter extends RecyclerView.Adapter<AllGdriveAdapter.MyClassView> {
    ...
    public AllGdriveAdapter(ArrayList<GDrive> gDriveArrayList, Activity activity, String name) {
    ...
    public MyClassView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = inflater.inflate(R.layout.item_list_drive, null, false);
