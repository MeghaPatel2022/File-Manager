...
public class OtherDownloadAdapter extends RecyclerView.Adapter<OtherDownloadAdapter.MyClassView> {

    ArrayList<DataModel> fileList = new ArrayList<>();
    Activity activity;

    public OtherDownloadAdapter(ArrayList<DataModel> fileList, Activity activity) {
    ...
    public MyClassView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = inflater.inflate(R.layout.item_other_images, null, false);
