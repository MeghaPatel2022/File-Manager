...
public class ImgDownloadAdapter extends RecyclerView.Adapter<ImgDownloadAdapter.MyClassView> {

    ArrayList<DataModel> fileList = new ArrayList<>();
    Activity activity;


    public ImgDownloadAdapter(ArrayList<DataModel> fileList, Activity activity) {
    ...
    public MyClassView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = inflater.inflate(R.layout.item_download_images, null, false);
